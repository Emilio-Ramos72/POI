...
CREATE VIEW V_MENSAJES AS
	Select M.FK_IDEMISSOR AS EMISSOR_ID,M.FK_IDRECEPTOR AS RECEPTOR_ID, IDRECEPTOR.NOMBRE AS NOMBRE_RECEPTOR,M.MENSAJE,M.HORA,  IDRECEPTOR.ACTIVO, IDRECEPTOR.LASTTIME,
			M.ENCRIPTACION
	from  MENSAJE M
