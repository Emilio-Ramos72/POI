...
DELIMITER $$
CREATE PROCEDURE `sp_MENSAJE_C` (in MENSAJES VARCHAR (500), IN RECEPTOR INT, IN EMISOR INT)
BEGIN


INSERT INTO MENSAJE(MENSAJE,HORA, FK_IDRECEPTOR, FK_IDEMISSOR) 
VALUES(MENSAJES,NOW(),RECEPTOR ,EMISOR);
END
$$
